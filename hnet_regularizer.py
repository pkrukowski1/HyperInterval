...
def calc_fix_target_reg(hnet, task_id, eps, targets=None, dTheta=None, dTembs=None,
    ...
    for i in ids_to_reg:
        weights_predicted = hnet.forward(cond_id=i, weights=weights, perturbated_eps=eps)
        ...
        if targets is not None:
            ...
            with torch.no_grad():
                target = hnet.forward(cond_id=i, weights=prev_weights, perturbated_eps=eps)
